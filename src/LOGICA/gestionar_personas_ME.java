...
/////////////////////////////////////////////////////////////////////////////////////////////
/*
nos encontramos nuestra clase principal "gestionar_personas_ME " que es la encargada de contener 
...
*/
public class gestionar_personas_ME implements ActionListener{
/*
...
//se pasan constantemente con la interaccion del usuario   
      ...
      public gestionar_personas_ME() {
        
      
        
    }
      
    public gestionar_personas_ME(GUI_personasME m) {
        this.m = m;
...
*/ 
    ...
    public void guardar(Modelo_ME datos){
        informacion.addElement(datos);
        
    }
        public void guardarArchivo(Modelo_ME datosArchivo){
            try {
                FileWriter s =new FileWriter("Gestion_Medicos_Especialistas.txt",true);
...
*/    
        public DefaultTableModel  mostrar(){
            ...
            try {
                FileReader leer = new FileReader("Gestion_Medicos_Especialistas.txt");
