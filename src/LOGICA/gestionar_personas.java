...
/////////////////////////////////////////////////////////////////////////////////////////////
/*
nos encontramos nuestra clase principal "gestionar_personas " que es la encargada de contener 
...
*/
public class gestionar_personas implements ActionListener{
/*
...
//se pasan constantemente con la interaccion del usuario   
    ...
    public gestionar_personas(GUI_personas p) {
  }

    public gestionar_personas( ) {
...
*/   
    ...
    public void guardar(Modelo_personas datos){
        informacion.addElement(datos);
        
    }
        public void guardarArchivo(Modelo_personas datosArchivo){
            try {
                FileWriter s =new FileWriter("Gestion_Afiliados.txt",true);
...
*/    
        public DefaultTableModel  mostrar(){
            ...
            try {
                FileReader leer = new FileReader("Gestion_Afiliados.txt");
