...
/////////////////////////////////////////////////////////////////////////////////////////////
/*
nos encontramos nuestra clase principal "GUI_servicio " que es la encargada de contener 
...
*/
public class GUI_servicio extends javax.swing.JFrame {
 /*
...
*/    
    Modelo_servicio  m =new Modelo_servicio();
    gestionar_servicio g = new gestionar_servicio();  
...
*/     
    imagen_fondo vg = new imagen_fondo();
 /*
...
*/
    ...
    private void initComponents() {
        ...
        Consultorio.setBorder(javax.swing.BorderFactory.createTitledBorder("Consultorio"));

        Especialidad.setBorder(javax.swing.BorderFactory.createTitledBorder("Especialidad "));
        ...
        jLabel2.setText("INFORMACION DISPONIBLE SOBRE LAS CITAS AGENDADAS ");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(8, 8, 8))
                            .addComponent(Modificar, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18))))
        );
...
*/       
        if (Nombre.getText().trim().isEmpty() ||Apellidos.getText().trim().isEmpty() || Consultorio.getText().trim().isEmpty()|| Id.getText().trim().isEmpty()|| Doctor.getText().trim().isEmpty()|| Especialidad.getText().trim().isEmpty()|| Fecha.getText().trim().isEmpty()|| Hora.getText().trim().isEmpty()) {
          ...
          String id = Id.getText();
           String doctor = Doctor.getText();
            String especialidad = Especialidad.getText();
             String consultorio = Consultorio.getText();
...
*/       
        ...
        try {
            ...
            String h = "Gestion_Consultas.txt";
         ...
         JOptionPane.showMessageDialog(null,"los datos han sido borrados conexito");
...
*/
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_servicio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_servicio().setVisible(true);
            }
        });
    }
